...
python scripts/train_feature_rectified_flow_sr.py \
  ...
  --allow_tf32 \
  --resume runs/feature_rectified_flow_x2_autocut_512_bench_wandb/warmup_top2/f3/checkpoints/last.pt \
  --wandb \
  --wandb_project feature-rectified-flow-sr \
  --wandb_name decoder_feature_flow_sr_f3_resume \
  --output_dir runs/decoder_feature_flow_sr_f3_resume
